% left hemisphere's negative-negative ROI
% negative preference first

clear;
close all;

load('roi_Data.mat', 'rnn_roi');
...
j=1; 
for i=1:numel(rnn_roi(:,1))
    if (rnn_roi(i, 5)+rnn_roi(i, 8)) - (rnn_roi(i, 17)+rnn_roi(i, 20)) < -2*B_thr ...
            && (abs(rnn_roi(i, 5))<B_lim && abs(rnn_roi(i, 8))<B_lim && abs(rnn_roi(i, 17))<B_lim && abs(rnn_roi(i, 20))<B_lim) ...
            && (abs(rnn_roi(i, 11))<B_lim && abs(rnn_roi(i, 14))<B_lim && abs(rnn_roi(i, 23))<B_lim && abs(rnn_roi(i, 26))<B_lim) ...
...
j=1; 
for i=1:numel(rnn_roi(:,1))
    if (rnn_roi(i, 17)+rnn_roi(i, 20)) - (rnn_roi(i, 5)+rnn_roi(i, 8)) < -2*B_thr ... 
            && (abs(rnn_roi(i, 5))<B_lim && abs(rnn_roi(i, 8))<B_lim && abs(rnn_roi(i, 17))<B_lim && abs(rnn_roi(i, 20))<B_lim) ...
            &&  (abs(rnn_roi(i, 11))<B_lim && abs(rnn_roi(i, 14))<B_lim && abs(rnn_roi(i, 23))<B_lim && abs(rnn_roi(i, 26))<B_lim) ...
%             && (ldn_roi(i, 6)>t_thr || ldn_roi(i, 9)>t_thr || ldn_roi(i, 18)>t_thr || ldn_roi(i, 21)>t_thr) ...
%             && (ldn_roi(i, 12)<-t_thr || ldn_roi(i, 15)<-t_thr || ldn_roi(i, 24)<-t_thr || ldn_roi(i, 27)<-t_thr) %((ldn_roi(i, 6)+ldn_roi(i, 9))> 2*t_thr || (ldn_roi(i, 18)+ldn_roi(i, 21)> 2*t_thr))
        reye_bias_ldn(j, :)=rnn_roi(i, :);
        j=j+1;
    end
end
...
j=1; 
for i=1:numel(rnn_roi(:,1))
    if (rnn_roi(i, 5)+rnn_roi(i, 17)) - (rnn_roi(i, 8)+rnn_roi(i, 20)) < -2*B_thr ...
            && (abs(rnn_roi(i, 5))<B_lim && abs(rnn_roi(i, 8))<B_lim && abs(rnn_roi(i, 17))<B_lim && abs(rnn_roi(i, 20))<B_lim) ...
            &&  (abs(rnn_roi(i, 11))<B_lim && abs(rnn_roi(i, 14))<B_lim && abs(rnn_roi(i, 23))<B_lim && abs(rnn_roi(i, 26))<B_lim) ...
%             && (ldn_roi(i, 6)>t_thr || ldn_roi(i, 9)>t_thr || ldn_roi(i, 18)>t_thr || ldn_roi(i, 21)>t_thr) ...
...
j=1; 
for i=1:numel(rnn_roi(:,1))
    if (rnn_roi(i, 8)+rnn_roi(i, 20)) - (rnn_roi(i, 5)+rnn_roi(i, 17)) < -2*B_thr ... 
            && (abs(rnn_roi(i, 5))<B_lim && abs(rnn_roi(i, 8))<B_lim && abs(rnn_roi(i, 17))<B_lim && abs(rnn_roi(i, 20))<B_lim) ...
            && (abs(rnn_roi(i, 11))<B_lim && abs(rnn_roi(i, 14))<B_lim && abs(rnn_roi(i, 23))<B_lim && abs(rnn_roi(i, 26))<B_lim) ...
%             && (ldn_roi(i, 6)>t_thr || ldn_roi(i, 9)>t_thr || ldn_roi(i, 18)>t_thr || ldn_roi(i, 21)>t_thr) ...
%             && (ldn_roi(i, 12)<-t_thr || ldn_roi(i, 15)<-t_thr || ldn_roi(i, 24)<-t_thr || ldn_roi(i, 27)<-t_thr) %((ldn_roi(i, 9)+ldn_roi(i, 21))> 2*t_thr || (ldn_roi(i, 6)+ldn_roi(i, 18)> 2*t_thr))
        rori_bias_ldn(j, :)=rnn_roi(i, :);
        j=j+1;
    end
end
...
%% ring negative biased 

%%
% extract left eye biased voxels
j=1; 
for i=1:numel(rnn_roi(:,1))
    if (rnn_roi(i, 11)+rnn_roi(i, 14)) - (rnn_roi(i, 23)+rnn_roi(i, 26)) < -2*B_thr ...
            && (abs(rnn_roi(i, 5))<B_lim && abs(rnn_roi(i, 8))<B_lim && abs(rnn_roi(i, 17))<B_lim && abs(rnn_roi(i, 20))<B_lim) ...
            && (abs(rnn_roi(i, 11))<B_lim && abs(rnn_roi(i, 14))<B_lim && abs(rnn_roi(i, 23))<B_lim && abs(rnn_roi(i, 26))<B_lim) ...
%             && (ldn_roi(i, 6)>t_thr || ldn_roi(i, 9)>t_thr || ldn_roi(i, 18)>t_thr || ldn_roi(i, 21)>t_thr) ... 
%             && (ldn_roi(i, 12)<-t_thr || ldn_roi(i, 15)<-t_thr || ldn_roi(i, 24)<-t_thr || ldn_roi(i, 27)<-t_thr) %((ldn_roi(i, 6)+ldn_roi(i, 9))> 2*t_thr || (ldn_roi(i, 18)+ldn_roi(i, 21)> 2*t_thr))
...
j=1; 
for i=1:numel(rnn_roi(:,1))
    if (rnn_roi(i, 23)+rnn_roi(i, 26)) - (rnn_roi(i, 11)+rnn_roi(i, 14)) < -2*B_thr ... 
            && (abs(rnn_roi(i, 5))<B_lim && abs(rnn_roi(i, 8))<B_lim && abs(rnn_roi(i, 17))<B_lim && abs(rnn_roi(i, 20))<B_lim) ...
            &&  (abs(rnn_roi(i, 11))<B_lim && abs(rnn_roi(i, 14))<B_lim && abs(rnn_roi(i, 23))<B_lim && abs(rnn_roi(i, 26))<B_lim) ...
%             && (ldn_roi(i, 6)>t_thr || ldn_roi(i, 9)>t_thr || ldn_roi(i, 18)>t_thr || ldn_roi(i, 21)>t_thr) ...
%             && (ldn_roi(i, 12)<-t_thr || ldn_roi(i, 15)<-t_thr || ldn_roi(i, 24)<-t_thr || ldn_roi(i, 27)<-t_thr) %((ldn_roi(i, 6)+ldn_roi(i, 9))> 2*t_thr || (ldn_roi(i, 18)+ldn_roi(i, 21)> 2*t_thr))
...
j=1; 
for i=1:numel(rnn_roi(:,1))
    if (rnn_roi(i, 11)+rnn_roi(i, 23)) - (rnn_roi(i, 14)+rnn_roi(i, 26)) < -2*B_thr ...
            && (abs(rnn_roi(i, 5))<B_lim && abs(rnn_roi(i, 8))<B_lim && abs(rnn_roi(i, 17))<B_lim && abs(rnn_roi(i, 20))<B_lim) ...
            &&  (abs(rnn_roi(i, 11))<B_lim && abs(rnn_roi(i, 14))<B_lim && abs(rnn_roi(i, 23))<B_lim && abs(rnn_roi(i, 26))<B_lim) ...
%             && (ldn_roi(i, 6)>t_thr || ldn_roi(i, 9)>t_thr || ldn_roi(i, 18)>t_thr || ldn_roi(i, 21)>t_thr) ...
%             && (ldn_roi(i, 12)<-t_thr || ldn_roi(i, 15)<-t_thr || ldn_roi(i, 24)<-t_thr || ldn_roi(i, 27)<-t_thr) %((ldn_roi(i, 9)+ldn_roi(i, 21))> 2*t_thr || (ldn_roi(i, 6)+ldn_roi(i, 18)> 2*t_thr))
...
j=1; 
for i=1:numel(rnn_roi(:,1))
    if (rnn_roi(i, 14)+rnn_roi(i, 26)) - (rnn_roi(i, 11)+rnn_roi(i, 23)) < -2*B_thr ... 
            && (abs(rnn_roi(i, 5))<B_lim && abs(rnn_roi(i, 8))<B_lim && abs(rnn_roi(i, 17))<B_lim && abs(rnn_roi(i, 20))<B_lim) ...
            && (abs(rnn_roi(i, 11))<B_lim && abs(rnn_roi(i, 14))<B_lim && abs(rnn_roi(i, 23))<B_lim && abs(rnn_roi(i, 26))<B_lim) ...
%             && (ldn_roi(i, 6)>t_thr || ldn_roi(i, 9)>t_thr || ldn_roi(i, 18)>t_thr || ldn_roi(i, 21)>t_thr) ...
%             && (ldn_roi(i, 12)<-t_thr || ldn_roi(i, 15)<-t_thr || ldn_roi(i, 24)<-t_thr || ldn_roi(i, 27)<-t_thr) %((ldn_roi(i, 9)+ldn_roi(i, 21))> 2*t_thr || (ldn_roi(i, 6)+ldn_roi(i, 18)> 2*t_thr))
