% left hemisphere's Disk-negative ROI
clear;
close all;

load('roi_Data.mat', 'ldn_roi');
...
for i=1:numel(ldn_roi(:,1))
    if (ldn_roi(i, 5)+ldn_roi(i, 8)) - (ldn_roi(i, 17)+ldn_roi(i, 20)) > 2*B_thr ...
            && (abs(ldn_roi(i, 5))<B_lim && abs(ldn_roi(i, 8))<B_lim && abs(ldn_roi(i, 17))<B_lim && abs(ldn_roi(i, 20))<B_lim) ...
            && (abs(ldn_roi(i, 11))<B_lim && abs(ldn_roi(i, 14))<B_lim && abs(ldn_roi(i, 23))<B_lim && abs(ldn_roi(i, 26))<B_lim) ...
...
j=1; 
for i=1:numel(ldn_roi(:,1))
    if (ldn_roi(i, 17)+ldn_roi(i, 20)) - (ldn_roi(i, 5)+ldn_roi(i, 8)) > 2*B_thr ... 
            && (abs(ldn_roi(i, 5))<B_lim && abs(ldn_roi(i, 8))<B_lim && abs(ldn_roi(i, 17))<B_lim && abs(ldn_roi(i, 20))<B_lim) ...
            &&  (abs(ldn_roi(i, 11))<B_lim && abs(ldn_roi(i, 14))<B_lim && abs(ldn_roi(i, 23))<B_lim && abs(ldn_roi(i, 26))<B_lim) ...
%             && (ldn_roi(i, 6)>t_thr || ldn_roi(i, 9)>t_thr || ldn_roi(i, 18)>t_thr || ldn_roi(i, 21)>t_thr) ...
%             && (ldn_roi(i, 12)<-t_thr || ldn_roi(i, 15)<-t_thr || ldn_roi(i, 24)<-t_thr || ldn_roi(i, 27)<-t_thr) %((ldn_roi(i, 6)+ldn_roi(i, 9))> 2*t_thr || (ldn_roi(i, 18)+ldn_roi(i, 21)> 2*t_thr))
        reye_bias_ldn(j, :)=ldn_roi(i, :);
        j=j+1;
    end
end
...
j=1; 
for i=1:numel(ldn_roi(:,1))
    if (ldn_roi(i, 5)+ldn_roi(i, 17)) - (ldn_roi(i, 8)+ldn_roi(i, 20)) > 2*B_thr ...
            && (abs(ldn_roi(i, 5))<B_lim && abs(ldn_roi(i, 8))<B_lim && abs(ldn_roi(i, 17))<B_lim && abs(ldn_roi(i, 20))<B_lim) ...
            &&  (abs(ldn_roi(i, 11))<B_lim && abs(ldn_roi(i, 14))<B_lim && abs(ldn_roi(i, 23))<B_lim && abs(ldn_roi(i, 26))<B_lim) ...
%             && (ldn_roi(i, 6)>t_thr || ldn_roi(i, 9)>t_thr || ldn_roi(i, 18)>t_thr || ldn_roi(i, 21)>t_thr) ...
...
j=1; 
for i=1:numel(ldn_roi(:,1))
    if (ldn_roi(i, 8)+ldn_roi(i, 20)) - (ldn_roi(i, 5)+ldn_roi(i, 17)) > 2*B_thr ... 
            && (abs(ldn_roi(i, 5))<B_lim && abs(ldn_roi(i, 8))<B_lim && abs(ldn_roi(i, 17))<B_lim && abs(ldn_roi(i, 20))<B_lim) ...
            && (abs(ldn_roi(i, 11))<B_lim && abs(ldn_roi(i, 14))<B_lim && abs(ldn_roi(i, 23))<B_lim && abs(ldn_roi(i, 26))<B_lim) ...
%             && (ldn_roi(i, 6)>t_thr || ldn_roi(i, 9)>t_thr || ldn_roi(i, 18)>t_thr || ldn_roi(i, 21)>t_thr) ...
%             && (ldn_roi(i, 12)<-t_thr || ldn_roi(i, 15)<-t_thr || ldn_roi(i, 24)<-t_thr || ldn_roi(i, 27)<-t_thr) %((ldn_roi(i, 9)+ldn_roi(i, 21))> 2*t_thr || (ldn_roi(i, 6)+ldn_roi(i, 18)> 2*t_thr))
        rori_bias_ldn(j, :)=ldn_roi(i, :);
        j=j+1;
    end
end
