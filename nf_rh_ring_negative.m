...
for i=1:numel(rrn_roi(:,1))
    if (rrn_roi(i, 5)+rrn_roi(i, 8)) - (rrn_roi(i, 17)+rrn_roi(i, 20)) < -2*B_thr ...
...
j=1; 
for i=1:numel(rrn_roi(:,1))
    if (rrn_roi(i, 17)+rrn_roi(i, 20)) - (rrn_roi(i, 5)+rrn_roi(i, 8)) < -2*B_thr ... 
            && (abs(rrn_roi(i, 5))<B_lim && abs(rrn_roi(i, 8))<B_lim && abs(rrn_roi(i, 17))<B_lim && abs(rrn_roi(i, 20))<B_lim) ...
            &&  (abs(rrn_roi(i, 11))<B_lim && abs(rrn_roi(i, 14))<B_lim && abs(rrn_roi(i, 23))<B_lim && abs(rrn_roi(i, 26))<B_lim) ...
%             && (ldn_roi(i, 6)>t_thr || ldn_roi(i, 9)>t_thr || ldn_roi(i, 18)>t_thr || ldn_roi(i, 21)>t_thr) ...
%             && (ldn_roi(i, 12)<-t_thr || ldn_roi(i, 15)<-t_thr || ldn_roi(i, 24)<-t_thr || ldn_roi(i, 27)<-t_thr) %((ldn_roi(i, 6)+ldn_roi(i, 9))> 2*t_thr || (ldn_roi(i, 18)+ldn_roi(i, 21)> 2*t_thr))
...
j=1; 
for i=1:numel(rrn_roi(:,1))
    if (rrn_roi(i, 5)+rrn_roi(i, 17)) - (rrn_roi(i, 8)+rrn_roi(i, 20)) < -2*B_thr ...
            && (abs(rrn_roi(i, 5))<B_lim && abs(rrn_roi(i, 8))<B_lim && abs(rrn_roi(i, 17))<B_lim && abs(rrn_roi(i, 20))<B_lim) ...
            &&  (abs(rrn_roi(i, 11))<B_lim && abs(rrn_roi(i, 14))<B_lim && abs(rrn_roi(i, 23))<B_lim && abs(rrn_roi(i, 26))<B_lim) ...
%             && (ldn_roi(i, 6)>t_thr || ldn_roi(i, 9)>t_thr || ldn_roi(i, 18)>t_thr || ldn_roi(i, 21)>t_thr) ...
...
j=1; 
for i=1:numel(rrn_roi(:,1))
    if (rrn_roi(i, 8)+rrn_roi(i, 20)) - (rrn_roi(i, 5)+rrn_roi(i, 17)) < -2*B_thr ... 
            && (abs(rrn_roi(i, 5))<B_lim && abs(rrn_roi(i, 8))<B_lim && abs(rrn_roi(i, 17))<B_lim && abs(rrn_roi(i, 20))<B_lim) ...
            && (abs(rrn_roi(i, 11))<B_lim && abs(rrn_roi(i, 14))<B_lim && abs(rrn_roi(i, 23))<B_lim && abs(rrn_roi(i, 26))<B_lim) ...
%             && (ldn_roi(i, 6)>t_thr || ldn_roi(i, 9)>t_thr || ldn_roi(i, 18)>t_thr || ldn_roi(i, 21)>t_thr) ...
%             && (ldn_roi(i, 12)<-t_thr || ldn_roi(i, 15)<-t_thr || ldn_roi(i, 24)<-t_thr || ldn_roi(i, 27)<-t_thr) %((ldn_roi(i, 9)+ldn_roi(i, 21))> 2*t_thr || (ldn_roi(i, 6)+ldn_roi(i, 18)> 2*t_thr))
